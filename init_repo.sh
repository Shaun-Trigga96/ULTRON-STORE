...
echo -e "  2. Read DEPLOYMENT_GUIDE.md for step-by-step cloud deployment (Dev -> Prod)"
echo -e "  3. Run 'make help' to see all developer targets"
echo -e "  4. Spin up local stack: 'make dev-up'"
echo -e "  5. Validate Terraform: 'make tf-init && make tf-plan-dev'"
